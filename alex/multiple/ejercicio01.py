...
# si el total supera los S/. 350.00, ganaste la tarjeta dorada
if( total>350):
    print("Ud ha ganado la tarjeta dorada")
# fin_if

# si el total es igual a S/. 350.00, ganaste la tarjeta de plata
if( total==350):
    print(" Ud ha ganado la tarjeta de plata")
# fin_if

# si el total es menor a S/. 350.00, ganaste la tarjeta de cobre
if( total<350):
